...
const UploadPage = () => {
  ...
  if (!user) {
    return (
      <div className="max-w-2xl mx-auto space-y-8 p-8 text-center">
        <h1 className="font-display text-5xl mb-4">UPLOAD NOTES.</h1>
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 p-8">
      ...
      <div className="text-center space-y-4">
        <h1 className="font-display text-5xl">UPLOAD YOUR NOTES.</h1>
        <p className="text-gray-600">Share your knowledge with the community and help others learn</p>
      </div>

      {/* Guidelines */}
      <div className="neo-card bg-[#b7c6c2] p-6">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex items-start space-x-2">
            <AlertCircle className="w-4 h-4 text-[#b7c6c2] mt-0.5 flex-shrink-0" />
      ...
      <div className="neo-card bg-white p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="border-2 border-dashed border-black bg-[#b7c6c2] p-8 text-center transition-colors">
              <input
                id="file"
                type="file"
                accept=".pdf,.docx,.txt"
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              type="text"
              className="neo-input w-full px-3 py-3"
              placeholder="e.g., Java, C++, Web Development, or any subject"
          ...
          {/* Premium Toggle */}
          <div className="flex items-center justify-between border-2 border-black bg-[#b7c6c2] p-4">
            <div className="space-y-1">
              <div className="flex items-center space-x-2">
                <label htmlFor="premium" className="text-sm font-medium text-gray-700">
                  Premium Content
                </label>
                <span className="px-2 py-1 text-xs font-medium bg-[#b7c6c2] text-black rounded-full flex items-center">
          ...
          <button
            type="submit"
            className="neo-btn w-full bg-black text-white py-3 px-4 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
